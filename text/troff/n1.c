...
/*
 * Copyright (c) AT&T Bell Laboratories
 */
...
main(int argc, char *argv[])
{
	...
	ifile  = stdin; /* linux does not allow it outside a function */
	ptid = stdout; /* see above */
...
void dwb_getline(char *s, int n)	/* get rest of input line into s */
{
	int i;
