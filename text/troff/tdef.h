...
#define	NCHARS	(7*1024+ALPHABET)	/* maximum size of troff character set*/
...
#define	NROFFCHARS	512+ALPHABET	/* maximum size of troff character set */
...
extern struct Term {
	...
	char	*codetab[NROFFCHARS-ALPHABET];
...
struct Numerr {
	...
	int	req;	/* was request or macro named req */
};
