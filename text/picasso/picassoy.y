...
picture:
	...
	| PLACENAME ':' position ST	{ $$=y.o= fixpos($3, 0., 0.);
						makevar($1,PLACENAME,y); }
	| asgn ST			{ y.f = $1; /* ??? */ $$ = y.o; }
	| dup ST
	| transform ST
	| DIR				{ setdir($1); }
...
transform:
	...
	| TRANSLATE optby position
				{ y.o=getlast(1, OBJECT); $$=y.o;
				  xlate(y.o,$3); }
	| SCALE '=' expr	{ rescale($3);   }
	| SCALE place optby exprlist
				{ $$=$2; scale($2, $4, $2); }
	| SCALE optby exprlist	{ y.o=getlast(1, OBJECT); $$=y.o;
				  scale(y.o, $3, y.o); }
	...
	| ROTATE place optby expr
				{ $$=$2; rotate($2, $4, $2); }
	| ROTATE optby expr	{ y.o=getlast(1, OBJECT); $$=y.o;
				  rotate(y.o, $3, y.o); }
	...
	| ROTATE optby expr AT position
				{ y.o=getlast(1, OBJECT); $$=y.o;
				  rotate(y.o, $3, $5); }
	| REFLECT place		{ $$=$2; reflect($2, $2); }
	| REFLECT place AT position
				{ $$=$2; reflect($2, $4); }
	| REFLECT AT position	{ y.o=getlast(1, OBJECT); $$=y.o;
				  reflect(y.o, $3); }
