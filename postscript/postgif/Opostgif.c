...
char	*optnames = "a:c:fglm:n:o:p:x:y:C:DG:IL:P:";
    ...
    int bp;
{
    ...
    if (gammaflag)
	    ...
	    *p = (unsigned char) (pow((double) *p/256.0, dwb_gamma)*256);
	    p[1] = *p; p[2] = *p;
	}
