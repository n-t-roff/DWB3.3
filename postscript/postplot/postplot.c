...
FILE	*fp_out;		/* and write stuff here */
 ...
 */
    ...
    fp_in = stdin;			/* read from this file */
    fp_out = stdout;		/* and write stuff here */
 ...
 */
	...
	switch(c) {
		...
		x1 = getint();
		y1 = getint();
		fprintf(fp_out, "cleartomark saveobj restore\n");
		fprintf(fp_out, "%d %d space\n", x1-x0, y1-y0);
		fprintf(fp_out, "/saveobj save def mark\n");
